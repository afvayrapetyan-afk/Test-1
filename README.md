...
## 🚀 Деплой и публичная демо-ссылка

**Быстрый старт (5 минут):**

1. Создайте репозиторий на GitHub: https://github.com/new
2. Отправьте код: `git remote add origin https://github.com/YOUR_USERNAME/ai-business-portfolio-manager.git && git push -u origin main`
3. Деплой на Vercel: https://vercel.com/signup → Import Project

📖 **Инструкции:**
- ⚡ [QUICK_DEPLOY.md](QUICK_DEPLOY.md) - 3 простых шага
- 📚 [DEPLOYMENT.md](DEPLOYMENT.md) - Подробная инструкция
- 🤖 Или запустите: `./deploy.sh` - автоматический деплой

**После деплоя получите ссылку вида:** `https://ai-business-portfolio-manager.vercel.app`

### Тестовые учетные данные:
- **Пользователь**: `vardana@example.com` / `demo123`
- **Админ панель** (`/login`): `Админ` / `987654`
